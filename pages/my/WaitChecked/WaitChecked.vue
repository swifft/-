	...
	<view :style="{height:phoneHeight + 'px'}">
		...
		<template v-else>
			<view class="box">
				...
				<uni-list v-if="classInfo.finish == '未完成'">
					<uni-list-item title="请假条" :rightText="classInfo.create_time | time" @tap="goProgress('class')"></uni-list-item>
				</uni-list>
				<view v-if="classInfo.finish == '完成'" class="tips">
					<view>
						<image src="../../../static/my/nothing.png"></image>
					</view>
					<view>
